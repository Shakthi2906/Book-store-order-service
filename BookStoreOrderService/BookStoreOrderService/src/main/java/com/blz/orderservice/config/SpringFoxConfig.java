package com.blz.orderservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.orderservice.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("BookStoreService",
                ...
                "1.0",
                "Terms of service",
                new Contact("Fundoo", "http://bridgelabz.fundoo", "svarma852@gmail.com"),
                "Apache 2.0",
